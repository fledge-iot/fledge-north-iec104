...
uint32_t IEC104Server::send(const vector<Reading*>& readings)
{
         ...
         reading++)
    {
        ...
        auto asdu_cot = static_cast<CS101_CauseOfTransmission>(
            hdpv->at(1)->getData().toInt());
        int asdu_isneg = hdpv->at(2)->getData().toInt();
        int asdu_oa = hdpv->at(3)->getData().toInt();
        int asdu_istest = hdpv->at(4)->getData().toInt();
        auto asdu_type =
            static_cast<IEC60870_5_TypeID>(hdpv->at(5)->getData().toInt());

        int io_ioa = idpv->at(0)->getData().toInt();
        auto io_quality =
            static_cast<QualityDescriptor>(idpv->at(1)->getData().toInt());
        auto io_value = idpv->at(6)->getData();

        CS101_AppLayerParameters alParams =
            CS104_Slave_getAppLayerParameters(m_slave);
        CS101_ASDU newAsdu =
            CS101_ASDU_create(alParams, false, asdu_cot, asdu_oa, asdu_ca,
                              asdu_istest, asdu_isneg);
        ...
        switch (asdu_type)
        {
            case M_ME_NA_1:
            {
                ...
                InformationObject io =
                    (InformationObject)MeasuredValueNormalized_create(
                        NULL, io_ioa, io_value.toDouble(), io_quality);
            ...
            case M_ME_NC_1:
            {
                ...
                InformationObject io =
                    (InformationObject)MeasuredValueShort_create(
                        NULL, io_ioa, io_value.toDouble(), io_quality);
                CS101_ASDU_addInformationObject(newAsdu, io);
                InformationObject_destroy(io);
                CS104_Slave_enqueueASDU(m_slave, newAsdu);
            ...
            case M_DP_TB_1:
            {
                ...
                InformationObject io =
                    (InformationObject)DoublePointWithCP56Time2a_create(
                        NULL, io_ioa,
                        static_cast<DoublePointValue>(io_value.toInt()),
                        io_quality, &CP56TT);
                CS101_ASDU_addInformationObject(newAsdu, io);
                InformationObject_destroy(io);
                CS104_Slave_enqueueASDU(m_slave, newAsdu);
            ...
            case M_ME_NB_1:
            {
                ...
                InformationObject io =
                    (InformationObject)MeasuredValueScaled_create(
                        NULL, io_ioa, io_value.toInt(), io_quality);
                CS101_ASDU_addInformationObject(newAsdu, io);
                InformationObject_destroy(io);
                CS104_Slave_enqueueASDU(m_slave, newAsdu);
                CS101_ASDU_destroy(newAsdu);
            ...
            case M_ST_TB_1:
            {
                ...
                InformationObject io =
                    (InformationObject)StepPositionWithCP56Time2a_create(
                        NULL, io_ioa, io_value.toInt(), false, io_quality,
                        &CP56TT);
                CS101_ASDU_addInformationObject(newAsdu, io);
                InformationObject_destroy(io);
                CS104_Slave_enqueueASDU(m_slave, newAsdu);
            ...
            case M_SP_TB_1:
            {
                ...
                InformationObject io =
                    (InformationObject)SinglePointWithCP56Time2a_create(
                        NULL, io_ioa, io_value.toInt(), io_quality, &CP56TT);
                CS101_ASDU_addInformationObject(newAsdu, io);
                InformationObject_destroy(io);
                CS104_Slave_enqueueASDU(m_slave, newAsdu);
                CS101_ASDU_destroy(newAsdu);
            ...
            default:
            {
                m_log->warn("%s is of unknown or not handled ASDU type %i",
                            assetName.c_str(), asdu_type);
                return false;
            }
        }
        n++;
